...
void
lshuffle(relation_t * relation, int local_shuffle_range)
{
    int8_t* shuffled = (int8_t*)calloc(relation->num_tuples, sizeof(int8_t));
    int i;
 ...
 */
void
random_unique_gen_lshuffle(relation_t *rel, int local_shuffle_range)
{
    uint32_t i;
    ...
    /* randomly shuffle elements */
    lshuffle(rel, local_shuffle_range);
}
...
int
create_relation_pk_lshuffle(relation_t *relation, int32_t num_tuples, int32_t local_shuffle_range)
{
    check_seed();
    ...
    random_unique_gen_lshuffle(relation, local_shuffle_range);
